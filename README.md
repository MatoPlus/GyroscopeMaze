...
# Introduction
In this section, briefly talk about the rationale and the approach towards the final product reported on.
...
# Background Research
This is the section to discuss about the research your group have done regarding this project, including the papers you have read, the code segments you have referred to, or some video tutorial you have followed in building some of the parts, etc.
...
# Implementation
In this section, elaborate on the procedure and the detail of the implementations for your final product. Make sure to discuss both the software and hardware components. 
...
Explain briefly the contribution of each group member.
All group members should add their signatures at the end of this section. (You do that by printing a copy of the final report, each member signs manually then you scan, and upload to LEARN)
...
In this section, conduct a performance evaluation over your final product. You may perform a comparison between the performance of the final product and the original goal.
...
# Future Work
Briefly talk about the potential improvement over your current product as the possible future work, assuming you have the interest to further develop the product.
...
# References
Cite any papers, tutorials, videos, or code segments in this section

Brackeys. “START MENU in Unity.” YouTube, YouTube, 29 Nov. 2017, www.youtube.com/watch?v=zc8ac_qUXQY&amp;t=579s.
danionescu. “Gyroscope Led Control With Arduino.” Instructables, Instructables, 28 May 2019, www.instructables.com/id/Giroscope-led-controll-with-Arduino/.
Dejan. “Arduino and MPU6050 Accelerometer and Gyroscope Tutorial.” HowToMechatronics, 9 Apr. 2019, howtomechatronics.com/tutorials/arduino/arduino-and-mpu6050-accelerometer-and-gyroscope-tutorial/.
False Wisp Studios. “Spike Balls.” Asset Store, Unity Technologies, 26 Apr. 2017, assetstore.unity.com/packages/3d/environments/spike-balls-88160.
jrowberg. “i2cdevlib.” GitHub, 17 Oct. 2019, github.com/jrowberg/i2cdevlib.
“Maze Generation.” Maze Generation - Rosetta Code, Rosetta Code, 29 Oct. 2019, rosettacode.org/wiki/Maze_generation#C.23.
PixelMush. “Pixel Font - Tripfive.” Asset Store, Unity Technologies, 4 Aug. 2017, assetstore.unity.com/packages/2d/fonts/pixel-font-tripfive-64734.
Robojax. “Why Use Resistors with Push Button or Switch with Arduino.” YouTube, YouTube, 18 July 2018, www.youtube.com/watch?v=TTqoKcpIWkQ&amp;t=148s.
“UnityEvent.” Unity, Unity Technologies, 3 Feb. 2019, docs.unity3d.com/ScriptReference/Events.UnityEvent.html.
“Unity User Manual (2019.2).” Unity Documentation, Unity Technologies, 2019, docs.unity3d.com/Manual/index.html.
YounGen Tech. “Ball Pack.” Unity Asset Store, Unity Technologies, 21 Mar. 2011, assetstore.unity.com/packages/3d/props/ball-pack-446.
“[En] Arduino + Unity + MPU 6050 : Using Gyroscope to Control Unity.” Lessons, lessons.julien-drochon.net/arduino-unity-mpu-6050-using-gyoscope-to-control-unity3d/.
